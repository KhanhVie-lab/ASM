<template>
 ...
 <div class="container-fluid">
         ...
         <p>Danh sách video<br></p>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" data-aos-delay="100">
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">Chị đẹp đạp gió rẽ sóng | Tập 1</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
 
               <div class="d-flex align-items-center">
                 <img alt="" class="img-fluid post-author-img flex-shrink-0">
                 <div class="post-meta">
                   <p class="post-author">Khánh Vi</p>
                   <p class="post-date">
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" >
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">Thám tử lừng danh Conan | Tập 212: Vụ án giết người trong phòng kín</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" data-aos-delay="300">
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">2 ngày 1 đêm "Tự do, tự lo" mùa 2 | Tập 12</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12" data-aos-delay="300">
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">2 ngày 1 đêm "Tự do, tự lo" mùa 2 | Tập 13</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" data-aos-delay="300">
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">2 ngày 1 đêm "Tự do, tự lo" mùa 2 | Tập 14</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" data-aos-delay="300">
             <article>
               ...
               <h2 class="title">
                 <a href="http://localhost:5173/postsdetail">2 ngày 1 đêm "Tự do, tự lo" mùa 2 | Tập 15</a> <button class="btn btn-outline-primary">Like</button> |
                 <button class="btn btn-outline-success">Share </button>
               </h2>
